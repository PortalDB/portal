...
In this paper we propose a representation of an evolving graph, called
a \tg, which captures evolution of graph topology, and of attributes
of vertices and edges, continuously through time.  We develop a
compositional \tg algebra that includes a variety of useful
operations, including temporal selection, subgraph and aggregation,
and a rich class of analytics.  We present \ql, a system that
