...
VE and \sg is almost 2X worse than performance on \insql{slice}
because \insql{map} requires a coalescing operation as the last step,
while \insql{slice} does not.
...
\caption{Map vertex attribute into its length on the wiki-talk dataset.}
\label{fig:project}
\end{figure}
}
