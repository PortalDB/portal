...
Our \ql system implementation builds on Apache Spark with GraphX~\cite{DBLP:conf/osdi/GonzalezXDCFS14}, an
 ...
 HDFS, and can be viewed both as a graph and as a pair of RDDs.
