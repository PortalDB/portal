...
\insql{T} optionally includes vertex and edge attribute relations \tav
...
then there would be two tuples for $v_2$ in this relation whose
...
(Section~\ref{sec:algebra}).  \eat{We will then discuss how each operator
