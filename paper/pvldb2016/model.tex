...
called a \tg.  An example of a \tg is given in Figure~\ref{fig:tg_ve}.
We will use valid-time temporal SQL
relations~\cite{DBLP:conf/vldb/BohlenSS96} as our starting point in
specifying the semantics of the model.  In its basic form, a \tg is a
pair of temporal SQL relations $V$ and $E$ that represent evolution of
