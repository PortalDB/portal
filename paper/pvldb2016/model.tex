...
evolves continuously over time.\eat{ Our choice to represent
  continuous graph evolution is in contrast with a less-general
  discrete snapshot-based representation. } Following the SQL:2011
...
Figure~\ref{fig:tg_ve}.\eat{  In its basic form, a \tg is represented by a
...
and edge attributes with relations $A^{V}$ and $A^{E}$.}
...
{\bf Switching between \tg representations.}  The two representations are
