...
{\bf Map may uncoalesce \tav, \tae and \trg.}  Consider \insql{T1} in
...
(``first'' for all).  Note that$(v_2, [4/15, 7/15)$ is present in the
  ...
  the input \insql{T1}.  Further, because vertex properties took on
...
So far we have defined the operations in our temporal graph algebra.
Next we define another class of non-algebraic operations on evolving
graphs that are nevertheless very useful: analytics.

\vera{What I think we are leaving out: difference, structural
