...
Consider the evaluation of a unary operation \opp over the \ve
...
{\bf Subgraph requires FK enforcement for \tve.}  A very natural
...
a value is missing, and \insql{list} assocites with a key an ordered
...
over each group. \eat{ It is possible but inconvenient to express the
operations on lines 2---5 in temporal SQL because each vertex, edge or
attribute tuple in the result of $\gamma_{P}$ may belong to multiple
periods.}
