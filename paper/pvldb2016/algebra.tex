...
Computing arbitrary subgraphs of an evolving graph is beyond the scope
...
{\bf Subgraph may uncoalesce \trg.} \reminder{explain}
...
project out some or all non-key attributes of the vertices and of the
edges.  Like temporal subgraph matching
(Section~\ref{sec:algebra:subgraph}), 

{\bf Projection may uncoalesce \tav and \tae in \tve.}

{\bf Project may uncoalesce \trg.}
