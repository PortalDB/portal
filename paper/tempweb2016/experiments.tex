...
Computation of the number of edges for each vertex is performed using
...
The query is the same, replacing \insql{components} with
\insql{pagerank}.  PageRank was executed for 10 iterations or until
