...
including \insql{overlaps}, \insql{precedes} and \insql{contains} in
the \insql{TWhere} clause.  Unlike Temporal SQL, \ql explicitly
...
aggregates, so expressions like \insql{TGroup by 2 years} would
...
aggregates as \insql{first}, \insql{last}, and \insql{trend}.  Another
