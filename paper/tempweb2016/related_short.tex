...
\insql{overlaps}, \insql{precedes}, and \insql{contains}.  There are
several important distinctions between \ql and Temporal SQL.  SQL does
not support period aggregates, so expressions like \insql{TGroup by 2
  years} would require new user-defined functions on
...
which allows for such aggregates as \insql{first}, \insql{last}, and
\insql{trend}.  \ql support for snapshot analytics is also
