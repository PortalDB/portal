...
A \tg represents evolution of a single graph, e.g., the Web.\eat{, and
  models evolution of its topology and of vertex and edge attributes.}
...
fact \eat{(existence of a vertex or edge, or an assignment of a value
...
integrity holds on \insql{E} w.r.t. \insql{V}, guaranteeing that edges
only exist if their end points exist at the same time, on \insql{VA}
...
relational algebra.  We also support \eat{Pregel-style}graph analytics
