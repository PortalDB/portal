...
of values of non-key attributes of vertices and edges, which takes place
...
result of this query is in Figure~\ref{fig:q5}. \reminder{Make figure
  1 line to save space.}
...
\insql{vid} and \insql{tr} values of 20 vertices with the most
