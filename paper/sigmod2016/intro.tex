...
days, but not hours (finer) or months (coarser).  Furhtermore, the
...
that multiple datasets are avaiable, each describing a series of
crawls of different, but possibly overlapping, portions of the Web
graph.  Further, network states may be recorded at different, possily
