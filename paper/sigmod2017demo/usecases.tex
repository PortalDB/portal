...
\vera{No, we don't. The load command gives you the data, but it still
  needs a name if referred to elsewhere. How would you like to change
  this?}
...
\vera{We have a semantic ambiguity here that we need to fix. Now that
...
(\insql{vwhere}, \insql{ewhere}), node creation, analytics, map, and
