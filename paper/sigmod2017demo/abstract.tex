...
Evolving graphs represent evolution of common phenomena, from the Web
and social networks to biological pathways.  Analysis tasks on
evolving graphs include computing change of common graph measures
(influence, centrality, connectivity), zooming in and out on measures
of interest by modifying time granularity, and detecting temporal
patterns.
...
and executed in interactive time. \sys will be demonstrated here for
the first time.
