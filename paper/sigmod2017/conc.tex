...
In this paper we presented \tga: a tuple-stamped vertex and edge
relational model of evolving graphs and a rich set of operations with
point semantics.  TGA is TRA-vertex- and -edge-complete.  We show
reduction of each of our operations into TRA and further into RA with
additional primitives.

It is in our immediate plans to develop a declarative syntax for \tra,
making it accessible to a wider audience of users.  We described an
implementation of \ql in scope of Apache Spark, and studied performance
of operations on different physical representations.  Interestingly,
different physical implementations perform best for different
operations but support switching, opening up avenues for rule-based
and cost-based optimization.  Developing a query optimizer for \ql is
...
% Support for path queries - questions of efficiency and of semantics
