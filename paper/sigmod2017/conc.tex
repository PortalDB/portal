...
We described an impementation in scope of Apache Spark, and studied
performance of operations on different physical representations.
Interestingly, different physical implementations perform best for
different operations, opening up avenues for rule-based and cost-based
optimization.  Developing a query optimizer for \ql is in our
immediate plans.
