...
property in a separate relation), by 1NF relations with property key
and value as columns, or by a hash-based representation
of~\cite{DBLP:conf/sigmod/SunFSKHX15}.  We leave an experimental
comparison of different physical representations of vertex and egde
...
Figure~\ref{fig:tg_rg} shows \insql{T1} as a continuous sequence of
