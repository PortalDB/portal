...
\insql{3months}.  Purely relational iplementation of this primitive is
...
and can use functional programming constructs like \insql{map} and
\insql{flatMap}.  Split can be efficiently implemented with a
\insql{flatMap}, which emits multiple tuples as necessary by applying
...
they represent an interval.  Figure~\ref{fig:tg_rg} shows \insql{T1}
