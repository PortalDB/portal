...
the three temporal primitives we introduced in
section~\ref{sec:algebra:integrity} (coalesce, resolve, and
constrain), as well as the primitives described in~\cite{Dignos2012}:
