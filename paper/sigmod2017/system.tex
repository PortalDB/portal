...
of nontemporal relational operators, maintaining point semantics.
This allows our algebra to be implemented in any nontemporal
relational database.  In addition to the regular algebra operators, we
need several operators on individual temporal relations in \tve.  We
term these {\em primitives} to distinguish them from the \ql algebraic
operators.  They are extend, coalesce, normalize, and constrain.
...
shows the OG for \insql{T1} from Figure~\ref{fig:tg_rg}.
