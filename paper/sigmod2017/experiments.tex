...
\begin{minipage}[b]{2.1in}
\centering
\includegraphics[width=2.1in]{figs/subgraph_ngrams_build13.png}
\vspace{-0.2in}
...
\end{minipage}
\begin{minipage}[b]{2.1in}
\includegraphics[width=2.4in]{figs/deg_twitter_build14.png}
\vspace{-0.2in}
...
\centering
\includegraphics[width=2.4in]{figs/intersect_ngrams_build13.png}
\vspace{-0.2in}
