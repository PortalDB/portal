...
and diverges in \insql{intersection}.  \eat{\insql{difference} performance
is similar to \insql{intersection}.}
...
type of operation being performed.  \eat{VE provides the best
...
%\vspace{-0.2in}
\caption{\insql{ncr} followed by Components.}
\label{fig:ncrtocc}
\vspace{-0.1in}
\end{minipage}
\end{figure*}
