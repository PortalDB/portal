...
set-based operators, and a rich class of analytics.  We introduce
temporal primitives that allow to reduce temporal operators of our
algebra into nontemporal ones.  We show that our algebra is
...
representation is most efficient for all operations, but switching
