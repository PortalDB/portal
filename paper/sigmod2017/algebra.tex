...
reducibility~\cite{DBLP:reference/db/Bohlen092}.  Both principles
relate a temporal query language to a non-temporal query language that
it extends. In Section~\ref{sec:algebra:prelim} we state our design
choices and present two intuitive notions of completeness for a
non-temporal graph query language w.r.t. which we will evaluate
expressiveness of \tg algebra.  Then, in
Sections~\ref{sec:algebra:integrity}
...
In consequence, our data structure and algebraic operations can be
