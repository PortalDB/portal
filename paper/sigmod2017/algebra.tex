...
\resolve{f_1(k_1),\ldots,f_n(k_n)}{v_1',v_2' \gamma^T (E
...
\julia{Revise this paragraph.} We compute group periods based on window
...
over the constituent relations of $\ttt_1$ and $\ttt_2$.  We compute
$L(v_1,v_2,a,p) = \resolve{f_1(k_1),\ldots,f_n(k_n)}{q(\ttt_1,
  \ttt_2)}$, and then set $\te' = \coal{\pi_{v1,v2,p} L}$, and $\tae'
...
operator by a combinatin of node creation and edge creation.
