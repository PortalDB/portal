...
a set resolve function for all properties.  Period $[2/15, 4/15)$ is
  computed as a result of the join of $[2/15, 5/15)$ in T1 and [$2/15,
      ...
      periods instead of 5.  Figure~\ref{fig:tg_diff} is a result of
      temporal difference of T1 and T2.  The period from $[2/15,
        6/15)$ is coalesced into one because the graphs are
        equivalent.  \vera{these examples need to be reworked in \tve
          so as not to confuse or otherwise explained differently.}
