...
\setminus^T \}$.  Then $\tve_1 \oplus \tve_2 = \{ \tv_1 \oplus \tv_2,
\te_1 \oplus \te_2, map_{resolve}(\tav_1 \fullouterjoin^T \tav_2),$\\
$map_{resolve}(\tae_1 \fullouterjoin^T \tae_2) \}$, with all FK
constraints on \tav and \tae enforced.
\end{definition}
