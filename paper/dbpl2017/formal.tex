...
\begin{itemize}[noitemsep,topsep=0pt,itemindent=\dimexpr\labelwidth+\labelsep\relax,leftmargin=5pt]
...
al., define a more restrictive type of upward compatability termed {\em
  temporal semi-completeness}~\cite{Bohlen1995}\eat{ or
...
a property of sequenced semantics.  \tga is not temporally complete
both because it is not temporally semi-complete and because it uses
point semantics, thus violating change preservation.
