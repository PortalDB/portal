...
graph node, and then accumulating them into one.  \eat{This calls for an
operation that can group multiple nodes, in this case all of them,
into a new node.  Wood terms this operation {\em node
creation}~\cite{Wood2012} and shows that many graph languages such as
GraphQL~\cite{He2008} support it if there is a need to output new
