...
features.\eat{ and its expressiveness.}  Users will inspect optimized
...
provided by us and by members of the audience. Queries on very
  ...
  However, the DBLP data set that we will primarily use allows for
  ...
  over long time periods. Some queries on the nGrams data set also can
