...
union-compatiblity states that temporal sequences of \insql{T1} and
...
an intersection of the edges, or of the vertices, or both.  Query
\insql{Q4} in Section~\ref{sec:demo} gives an example.
