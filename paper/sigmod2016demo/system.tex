...
performance.  For example, pushing temporal aggregation before a
temporal join can sometimes lead to more efficient performance.  By
injecting temporal selection during load based on the following
temporal join we can also reduce execution time.

We developed several different physical representations
...
for exploratory data analysis.  Shell users can:
