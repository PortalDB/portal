...
points~\cite{DBLP:conf/vldb/BohlenSS96}.\eat{  Figure~\ref{fig:coalesced}
represents the network of Figure~\ref{fig:snapshots} as a pair of
coalesced temporal relations --- \insql{V} for vertices and \insql{E}
...
to graph vertices and edges, rather than to graph snapshots in their
...
a year.  Such queries cannot be evaluated directly over a sequence of
snapshots.
