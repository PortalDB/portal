...
and external memory and guarantee optimality of solution\eat{in $O(N
  ...
  memory}.  However, Le's approach is not the most efficient in a
...
\vera{I added the discussion on our new splitters here to give some
  concreteness.  But I wonder whether it's a good idea to make a claim
  without describing the algorithm itself.}
...
same splitters.  \eat{Because each entity (vertex or edge) evolves at
  ...
  one partition.}  An open question is what to do when a binary
