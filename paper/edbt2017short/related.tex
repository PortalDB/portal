...
of graphs.  \eat{In~\cite{Borgwardt2006} and~\cite{Kan2009} the time
...
temporal data has been throughly explored in the relational temporal
database community.  B{\"{o}}hlen et al.~\cite{Bohlen1998} have
formally defined the point and sequenced models and crisply defined
the differences between them.  They showed that the difference lies in
the properties of the operators of the models rather than in the use
of intervals as representational devices.  With this foundation,
Dign{\"{o}}s et al.~\cite{Dignos2012} have defined sequenced
semantics, with properties of snapshot reducibility, extended
snapshot reducibility, and change preservation, and shown how
