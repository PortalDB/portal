...
class OneGraphSuite extends RepresentationsTestSuite {
  ...
  test("slice function") {
    testSlice(OneGraph.emptyGraph("Default"))
  }

  test("temporal select function") {
    testTemporalSelect(OneGraph.emptyGraph("Default"))
  }

  test("structural select function") {
    testStructuralSelect(OneGraph.emptyGraph("Default"))
  }

  test("getSnapshot function") {
    testGetSnapshot(OneGraph.emptyGraph("Default"))
  }

  test("aggregateByTime -w/o structural") {
    testNodeCreateTemporal(OneGraph.emptyGraph("Default"))
  }
