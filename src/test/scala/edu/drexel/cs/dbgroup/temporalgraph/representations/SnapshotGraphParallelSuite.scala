...
class SnapshotGraphParallelSuite extends FunSuite with BeforeAndAfter {
  ...
  test("directed shortestPath") {
    ...
    val expectedNodes: RDD[(VertexId, (Interval, Map[VertexId, Int]))] = ProgramContext.sc.parallelize(Array(
      (1L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2014-01-01")), scala.collection.Map(5L -> 3, 6L -> 2).asJava)),
      (2L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2014-01-01")), scala.collection.Map(5L -> 2, 6L -> 1).asJava)),
      (3L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2014-01-01")), scala.collection.Map(5L -> 1, 6L -> 2).asJava)),
      (4L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2014-01-01")), scala.collection.Map(5L -> 1, 6L -> 2).asJava)),
      (5L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2014-01-01")), scala.collection.Map(5L -> 0, 6L -> 1).asJava)),
      (6L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map(6L ->0).asJava)),
      (7L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map[VertexId,Int]().asJava)),
      (8L, (Interval(LocalDate.parse("2010-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map[VertexId,Int]().asJava)),

      //second representative graph
      (1L, (Interval(LocalDate.parse("2014-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map(5L -> 1).asJava)),
      (2L, (Interval(LocalDate.parse("2014-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map(6L -> 1).asJava)),
      (3L, (Interval(LocalDate.parse("2014-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map[VertexId,Int]().asJava)),
      (4L, (Interval(LocalDate.parse("2014-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map[VertexId,Int]().asJava)),
      (5L, (Interval(LocalDate.parse("2014-01-01"), LocalDate.parse("2018-01-01")), scala.collection.Map(5L -> 0).asJava))
    ))
  ...
  test("directed pagerank") {
    ...
    for (i <- 0 until pageRank2010_2014VerticesSorted.length) {
      val difference = pageRank2010_2014VerticesSorted(i)._2 - actualSGP2010_2014VerticesSorted(i)._2._2
      assert(Math.abs(difference) < 0.0000001)
    }

    for (i <- 0 until pageRank2014_2018VerticesSorted.length) {
      val difference = pageRank2014_2018VerticesSorted(i)._2 - actualSGP2014_2018VerticesSorted(i)._2._2
      assert(Math.abs(difference) < 0.0000001)
    }
  }
