...
//    info("empty graph passed")
  ...
  test("aggregateByChange") {
    ...
    val actualSgp = sgp.aggregate(new TimeSpec(resolution1Month), (vid, attr1) => vid, AtLeast(0.5), AtLeast(0.5), (attr1, attr2) => attr2, (attr1, attr2) => attr2)
