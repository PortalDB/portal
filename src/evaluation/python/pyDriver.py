...
import re;
import traceback;
import src.evaluation.driverUtils.models
import src.evaluation.driverUtils.connect
import subprocess;
import configparser;
from peewee import *;
from subprocess import Popen, PIPE;
import src.evaluation.driverUtils.sendMail as sendMail
...
def create_op(oT, a1, a2, a3, a4, a5, pS, rW):
    ...
    op = src.evaluation.driverUtils.models.Operation(
...
def collect_args(query, strat, run):
    ...
    for i in range (0, len(line)):
        ...
        if line[i] == "group":
            ...
            if line[i+10] == "vgroup":
                arg5 = line[i+12].strip('\)')
	    elif line[i+10] == "with":
                arg5 = line[i+11].strip('\)')
            else:
                arg5 = None
            runW = int(line[i+2])
            partS = None
		...
		success = False
			...
			success = True
                        ...
                        if errorCount == 1:
                            ...
                            src.evaluation.driverUtils.sendMail.sendMail(email, msg)
                            sys.exit(1)
                ...
                if querySaved == False:
                    ...
                    if queryId is None:
                        ...
                        qRef = src.evaluation.driverUtils.models.Query.get((
                                                                           src.evaluation.driverUtils.models.Query.query_id == queryId))
                    querySaved = True
...
if __name__ == "__main__":
    ...
    try:
        database = src.evaluation.driverUtils.models.BaseModel._meta.database
        dbconnect = src.evaluation.driverUtils.connect.DBConnection(database)
