  ...
  def runCombined[VD: ClassTag, ED: ClassTag](graph: Graph[Map[Int, VD], (ED, Int)], numInts: Int): Graph[Map[Int, VertexId], (ED, Int)] =
    {
      ...
      val ccGraph: Graph[Map[Int, VertexId], (ED, Int)] = graph
        ...
        def vertexProgram(id: VertexId, attr: Map[Int, VertexId], msg: Map[Int, VertexId]): Map[Int, VertexId] = {
        ...
        def sendMessage(edge: EdgeTriplet[Map[Int, VertexId], (ED, Int)]): Iterator[(VertexId, Map[Int, VertexId])] = {
      ...
      val initialMessage: Map[Int, VertexId] = (for (i <- 0 to numInts) yield (i -> Long.MaxValue))(breakOut)
