...
import edu.drexel.cs.dbgroup.portal.{Exists => GExists}
import edu.drexel.cs.dbgroup.portal.plans.logical._
import edu.drexel.cs.dbgroup.portal.expressions.PropertyStar
