...
settings(
    ...
    mainClass in (Compile, packageBin) := Some("edu.drexel.cs.dbgroup.graphxt.SnapshotGraphTest"),
    mainClass in (Compile, run) := Some("edu.drexel.cs.dbgroup.graphxt.SnapshotGraphTest"),
